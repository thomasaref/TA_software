...
from numpy import float64, shape, reshape, linspace, mean, amin, amax, absolute, squeeze
...
file_path="/Users/thomasaref/Dropbox/Current stuff/Logbook/TA210715A46_cooldown1/Data_1005/TA_A46_test4.hdf5"

def read_D1005_file(file_path):
    ...
    return yoko, freq, Magcom

yoko, freq, Magcom=read_D1005_file(file_path)    
#powind=0
#frqind=234
#print pwr[powind]
...
if __name__=="__main__":
    ...
    cs_dB_meanyoko_trans()
    show()
    
    file_path="/Users/thomasaref/Dropbox/Current stuff/Logbook/TA210715A46_cooldown1/Data_1005/TA_A46_test5.hdf5"
    yoko, freq, Magcom=read_D1005_file(file_path) 
