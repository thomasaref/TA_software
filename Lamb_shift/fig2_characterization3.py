...
from TA88_fundamental import TA88_VNA_Lyzer, TA88_Read, qdt, idt, TA88_Read_NP, TA88_Save_NP, bg_A4, bg_A1
...
if __name__=="__main__":
    ...
    plbg.nplot=1
    line(d0527.frequency[::nskip]/1e9, 20.0*log10(magabs[::nskip])-bg_A4(d0527.frequency[::nskip]),
               color="blue",
    ...
    line(d0527.frequency/1e9, 20*log10(absolute(S13*S31))-4, color="red", pl=pl,
         auto_ylim=False, y_min=-40, y_max=0,
         auto_xlim=False, x_min=4.2, x_max=4.7, xlabel="Frequency (GHz)",
    ...
    plbg.nplot=1
    line(d0527.frequency/1e9, 20*log10(absolute(S13*S31))-4, color="red", pl=plbg,
    ...
    pl.axes.plot(d0317.frequency/1e9, 
...
#                  auto_xlim=False, x_min=-30-90, x_max=10-90)#.show()
    ...
    if 1:
        ...
        flux_axis=c.flux_axis[c.flat_flux_indices]
        freq_axis=c.freq_axis[c.indices]
        pl, pf=colormesh(flux_axis, freq_axis, 10**(cdata[c.end_skip:-c.end_skip, :]/20.0), pl=pl,
                         pf_too=True, auto_zlim=False,
                                   auto_xlim=False, x_min=0.65, x_max=1.5,
                                   auto_ylim=False, y_min=4.342, y_max=4.558, vmin=0.0, vmax=0.12)
