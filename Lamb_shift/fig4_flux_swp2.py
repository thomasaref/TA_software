...
a.save_folder.main_dir="fig4_flux_swp2"
...
#                    auto_xlim=False, x_min=-3, x_max=3)
    ...
    line(array([0.85, 1.10]), array([4.85, 4.85]), pl=pl, linestyle="dashed", color="cyan", linewidth=1.0)                       
    line(array([0.85, 1.10]), array([5.75, 5.75]), pl=pl, linestyle="dashed", color="cyan", linewidth=1.0)                       

    pl.axes.set_xticks(linspace(0.9, 1.1, 3))
