# -*- coding: utf-8 -*-
"""
Created on Wed Apr  8 09:35:21 2015
...
def start_VNA(instr, address):
    ...
    start_GPIB(instr, address="",  timeout = 60, do_reset=True)
    instr.measurement_type = 'S21'
    instr.hw_reset()

def hw_reset(self):
        #self.hw_write("SYSTem:PRESet") #ag
        #self.hw_write("DISP:WINDow1:TITLe ON") #ag
        #self.hw_write("DISP:WINDow1:TRACe:DELete") #ag
        self.hw_write("CALCulate1:PARameter:SDEFine 'PhaseTrc', '{meas_type}'".format(meas_type=self.measurement_type))
        self.hw.write("CALCulate1:FORMat PHASe")
        self.hw_write("DISPlay:WINDow1:TRACe1:FEED 'PhaseTrc'")
        #self.hw_write("CALCulate1:PARameter:SELect 'MyMag'") #ag
        #self.hw_write("CALCulate1:FORMat MLOG") #ag
        ...
        #DISPlay:WINDow2:STATe ON DISPlay:WINDow2:TRACe2:FEED 'Trc2'
        #// Trc2 is now displayed in both diagrams DISPlay:WINDow1:TRACe2:DELete
        #// Check the result on the local screen
        #// Go to local SYSTem:DISPlay:UPDate ONCE

#MMEMory:CDIRectory DEFault MMEMory:CDIRectory 'Traces'
#MMEMory:STORe:TRACe 'Trc1', 'S21.s1p' MMEMory:LOAD:TRACe 'Trc1', 'S21.s1p'
#// Alternative, more compact definition
#MMEMory:CDIRectory DEFault MMEMory:STORe:TRACe 'Trc1', 'Traces\S21.s1p'
