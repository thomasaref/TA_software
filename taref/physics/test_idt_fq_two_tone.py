...
f=linspace(4e9, 8e9, 400).astype(float64)
fq=linspace(1e9, 10e9, 500).astype(float64)
...
#Y0_arr=_get_Y0(f=f0, W=W, epsinf=epsinf, Dvv=Dvv)
...
plt.colorbar()
plt.figure()
plt.pcolormesh(fq, f, absolute(resp+resp2), cmap="RdBu_r", vmin=0.0, vmax=0.5)
plt.colorbar()
#plt.
