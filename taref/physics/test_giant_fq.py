...
from numpy import real, imag, log10, linspace, sin, amax, amin, argmin, argmax, cos, imag, sqrt, absolute, matrix, exp, eye, array, squeeze, float64, ones, log, meshgrid, argmin
...
print amax(absolute(S11)), amin(absolute(S11))
