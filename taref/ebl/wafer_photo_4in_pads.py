...
if __name__=="__main__":
    jdf_text="""
PATH
ARRAY (-42500, 8, 5000)/(42500, 8, 5000); A
   CHMPOS M1=(1500, 1500)
...
ARRAY (7500, 8, 5000)/(42500, 8, 5000); B
   CHMPOS M1=(1500, 1500)
...
"""
    ...
    horiz_long_line=Rectangle(name="HORIZ_LONG_LINE", height=1.0e-3, width=100.0e-3)
    vert_long_line=Rectangle(name="VERT_LONG_LINE", height=100.0e-3, width=1.0e-3)
