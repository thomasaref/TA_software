...
def flux_plots():
    ...
    pl1=scatter(data[:, 0], data[:, 1], fig_width=6.0, fig_height=4.0, color="red")
    ...
    pl2=scatter(data[:, 0], data[:, 1], fig_width=6.0, fig_height=4.0, color="red")
    line(freq, V2, pl=pl2, ylabel="Yoko (V)", xlabel="Frequency (GHz)")
    pl2.add_label("b)")

    pl3=scatter(data[:, 1], data[:, 0], fig_width=6.0, fig_height=4.0, color="red")
    line(V, freq, pl=pl3, xlabel="Yoko (V)", ylabel="Frequency (GHz)")
    pl3.add_label("c)")

    pl4=scatter(data[:, 1], data[:, 0], fig_width=6.0, fig_height=4.0, color="red")
