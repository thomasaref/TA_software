...
a=TA88_VNA_Lyzer(name="testing", on_res_ind=218, VNA_name="RS VNA", #241
              rd_hdf=TA88_Read(main_file="Data_0308/S1A4_TA88_coupling_search_midpeak.hdf5"), #S1A4_TA88_coupling_search.hdf5"),
              desc="looking",
              #offset=-0.09,
            #fit_indices=[range(19, 259+1),range(300, 566+1)],
            ) #33, 70

a.filt.center=31 #125
a.filt.halfwidth=10
