...
tx.tex_title="Strong, frequency dependent Lamb shift and coupling in a surface acoustic phononic vacuum"
...
if 1:
    tx.include_image("sample_images", label="sample_images",
        caption="""Two talking listening IDTs located 200 um and 300 um respectively from the QDT.
    ...
    tx.mult_fig_end(caption=r"a) combined filtered data colormaps (arbitrary color scales) b) Lorentzians fits colormap (arbitrary colorscales) c) centers of Lorentzians d) HWFM of Lorentzians")
