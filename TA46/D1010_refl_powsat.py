...
from TA210715A46_Fund import dB, fridge_attn, lorentzian, flux_rescale, flux_parabola
...
#pcolormesh(dB(powsat_theory))
#show()

plot(pwr2[:,0]-fridge_att, absolute(powsat_theory[:,56]))    
plot(pwr2[:,0]-fridge_att, normalize(powsat))#mean(dB(Magcom[0, :, 19:31]), axis=1))
