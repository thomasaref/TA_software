...
a=TA53_VNA_Two_Tone_Pwr_Lyzer(name="d1119", on_res_ind=59,#read_data=read_data, # VNA_name="RS VNA",
        rd_hdf=TA53_Read(main_file="Data_1119/S3A4_trans_split_n0dBm.hdf5"), #long_test.hdf5"), #
...
if __name__=="__main__":
    ...
    a.filter_type="None"
    pl1=colormesh(absolute(a.MagcomData[:, :])) #,
