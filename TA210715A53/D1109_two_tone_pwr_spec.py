...
def read_data(self):
    with File(self.rd_hdf.file_path, 'r') as f:
        ...
        sm=shape(Magvec)[0]
        s=(sm, self.frq2.shape[0], self.pwr2.shape[0], self.yoko.shape[0])
...
a=TA53_VNA_Two_Tone_Pwr_Lyzer(name="d1109", on_res_ind=178,#read_data=read_data, # VNA_name="RS VNA",
        rd_hdf=TA53_Read(main_file="Data_1109/S1A4_all_two_tone_pwr_spec2.hdf5"), #long_test.hdf5"), #
...
if 1:
    ...
    ps1.append(colormesh(a.yoko[:-1], a.pwr2, absolute(double_filt[86, :, fi,:]).transpose(),
