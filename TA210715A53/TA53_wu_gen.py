...
from TA53_fundamental import qdt, idt, ideal_qdt, ideal_idt
from taref.filer.read_file import Read_TXT
#/Users/thomasaref/Dropbox (Clan Aref)/Current stuff/Logbook/TA210715A53_cooldown022915/tex_source_files
tx=TEX(source_path=r"/Users/thomasaref/Dropbox/Current stuff/Logbook/TA210715A53_cooldown022915/tex_source_files/TA210715A53_writeup_source.tex")
#"/Users/thomasaref/Dropbox/Current stuff/test_data/source/TA210715A88_source/TA210715A88_writeup.tex")
tx.save_file.file_name="TA210715A53_writeupy"
tx.save_file.folder=Folder(base_dir="/Users/thomasaref/Dropbox/Current stuff/test_data", main_dir="TA_53", quality="")

tx.tex_title="Sample TA210715A53 in Lumi 23-08-16 cooldown"
...
if 1:
    ...
    for fn in file_names[:8]:
        if fn!="":
            tx.add_mult_image(fn, fn, "", d1113.save_folder)
    tx.mult_fig_end(caption=r"Two tone at various powers",
                    label="fig:pwr_2tone")
...
if include_text:
    ...
    tx.make_table(qdt.latex_table(['ft', 'ft_mult', 'Np', 'N_IDT', 'Ct_mult', 'W', 'Ct', "Cc", 'eta',
    ...
    tx.make_table(qdt.latex_table(["max_coupling_approx", "max_coupling", 'coupling','Lamb_shift', 'Ga0_mult', 'Ga0_approx', 'Ga0', 'Ga', 'Ba'], design=ideal_qdt),
                                   r"|p{3.5 cm}|p{3 cm}|p{3 cm}|p{3 cm}|p{3.5 cm}|")

    tx.add(r"\subsection{extra IDT properties}")
    tx.make_table(qdt.latex_table(['qubit_type', 'Y0_type','df_type', 'mus_type', "Ga_type", "Ba_type", "rs_type", "S_type", 'alpha0', 'alpha', 'fs',  'm', 's', 'YL',  'rs', 'ts', 'dloss1', 'dloss2', 'dL',  'Gs', 'N_fixed', 'fixed_freq_min', 'fixed_freq_max'], design=ideal_qdt),
                                   r"|p{3.5 cm}|p{3 cm}|p{3 cm}|p{3 cm}|p{3.5 cm}|")
    tx.add(r"\FloatBarrier")
