...
a=TA53_VNA_Two_Tone_Pwr_Lyzer(name="d1111", on_res_ind=60,#read_data=read_data, # VNA_name="RS VNA",
        rd_hdf=TA53_Read(main_file="Data_1111/S1A4_all_two_tone_pwr.hdf5"), #long_test.hdf5"), #
...
a.filt.center=8 #71 #28*0 #141 #106 #58 #27 #139 #106 #  #137
a.filt.halfwidth=4 #8 #10
...
if 1:
    ...
    colormesh(absolute(double_filt[75, :, 109, :]))#.show()
    colormesh(absolute(double_filt[75, :, 78, :]))#.show()

    colormesh(absolute(double_filt[a.end_skip:-a.end_skip, :, 109, 5])).show()
