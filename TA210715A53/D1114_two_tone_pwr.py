...
if __name__=="__main__":
    ...
    print double_filt.shape
    print a.frequency[75]
    pl3=colormesh(a.yoko, a.frq2/1e9, absolute(double_filt[75, :, :]).transpose(), xlabel="yoko (V)", ylabel="Freq 2 (GHz)",
    auto_xlim=False, x_min=2, x_max=2.9, auto_ylim=False, y_min=4, y_max=8)#.show() #.show() #a.frq2, a.yoko,
    pl4=colormesh(a.yoko, a.frq2/1e9, absolute(double_filt[75, :, :]).transpose()-absolute(double_filt[75, :, 200]), xlabel="yoko (V)", ylabel="Freq 2 (GHz)",
