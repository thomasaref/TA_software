...
from numpy import squeeze, shape, linspace, log10, mean, amax, amin, absolute, reshape, transpose, real, imag, angle, cos, sqrt, array, exp
...
file_path="/Users/thomasaref/Dropbox/Current stuff/Logbook/TA210715A58_cooldown1/Data_0916/TA_A58_scb_refl_powfluxswp_maxpow.hdf5"
...
if 1:
    plt.plot(pwr-87, absolute(mean(Magcom[220, :, 144:154], axis=1)-mean(Magcom[220, :, 209:219], axis=1)))
    plt.show()
#print freq[985:995]
#print freq[122:123]
