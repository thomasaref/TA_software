...
Gamma_ac = 40.0e6*2*pi# 38e6*2*pi;
Gamma_Phi = 0*2*pi
...
if 1:
    ...
    #plt.plot(10*log10(absolute(PXIIQ)**2))
    #plt.plot(dB(PXIavgpwr/0.001)/2.0)
    #plt.plot(pwr-87, absolute(mean(PXIIQ[:, 310:330], axis=1)-mean(PXIIQ[:, 410:430], axis=1)))
    #plt.plot(pwr-87, absolute(mean(S11c[:, 310:330], axis=1)-mean(S11c[:, 410:430], axis=1)))
    #plt.plot(S11)    
    #plt.plot( absolute(mean(S11c[:, 300:310], axis=1)))
    #plt.plot(absolute(mean(S11c[:, 420:430], axis=1)))
        
    #plt.plot(pwr-87, absolute(mean(Magcom[:, 310:330], axis=1)-mean(Magcom[:, 410:430], axis=1)))
