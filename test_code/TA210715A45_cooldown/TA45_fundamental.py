...
class TA45_Read(Read_HDF5):
    def _default_folder(self):
        return Folder(base_dir="/Users/thomasaref/Dropbox/Current stuff/Logbook/TA210715A45_cooldown270216", quality="", main_dir="Data_0227")

class TA45_Fund(Agent):
...
qdt=QDT(material='LiNbYZ',
        ...
        a=80.0e-9,
        Np=9,
        Rn=7000.0, #6700.0, #(7620.0+7960)/2.0,
        W=25.0e-6,
        eta=0.5,
        flux_factor=0.307, #0.2945,
        voltage=1.21,
        offset=-0.03)
...
if __name__=="__main__":
    ...
    if 1:
        ...
        freq=4.48e9
        G_f=0.5*Np*K2*f0*(sin(Np*pi*(freq-f0)/f0)/(Np*sin(pi*(freq-f0)/f0)))**2
        #b.scatter_plot("blah3", 200e6, G_f)
