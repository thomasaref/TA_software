...
class Lyzer(TA45_Fund):
    ...
    def MagAbs(self):
        ...
        return absolute(self.Magcom[:, :]-mean(self.Magcom[:, 4900:5100], axis=1, keepdims=True))


    def _default_rd_hdf(self):
        return TA45_Read(main_file="Data_0227/S4A4_TA45_wide_flux_sweep.hdf5")
...
if __name__=="__main__":
    ...
    def magabs_cs():
        b.line_plot("magabs_cs", c.flux_parabola[0:2000], a.MagAbs[0, 0:2000])
        b.line_plot("magabs_cs", c.flux_parabola[0:2000], a.MagAbs[1, 0:2000])
