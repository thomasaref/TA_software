...
class Lyzer(TA88_Fund):
    ...
    def _default_rd_hdf(self):
        return TA88_Read(main_file="Data_0311/S1A1_TA88_coupling_search_midpeak.hdf5") #"Data_0312/S4A1_TA88_coupling_search.hdf5")
...
if __name__=="__main__":
    ...
    def magabs_cs_fit():
        ...
        bb.line_plot("fft2", absolute(fft.fft(widths[175:444])))
