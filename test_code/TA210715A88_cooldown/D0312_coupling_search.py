...
class Lyzer(TA88_Fund):
    ...
    def _default_rd_hdf(self):
        return TA88_Read(main_file="Data_0313/S4A1_TA88_coupling_search_midpeak.hdf5") #"Data_0312/S4A1_TA88_coupling_search.hdf5")
...
if __name__=="__main__":
    ...
    def magabs_cs_fit():
        ...
        for ind_list in indices:
            for n in ind_list:
                ...
                if 0:#n % 8==0:
                    ...
                    bb.line_plot("lorentzian", c.flux_parabola*1e-9, fano(c.flux_parabola,best_parameters), label="fit {}".format(n), linewidth=0.5)
        ...
        bb.line_plot("fft2", absolute(fft.fft(widths[318:876])))
