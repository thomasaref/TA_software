...
from TA27_fundamental import TA27_Read, TA27_Fund, qdt
...
class Lyzer(TA27_Fund):
    rd_hdf=Typed(TA27_Read)
    ...
    def _default_rd_hdf(self):
        return TA27_Read(main_file="Data_0228/S4A4_TA27_SC1216_widefluxswp.hdf5")
...
if __name__=="__main__":
    ...
    def magabs_cs():
        b.line_plot("magabs_cs", c.flux_parabola[0:300], a.MagAbs[504, 0:300])
        b.line_plot("magabs_cs", c.flux_parabola[0:300], a.MagAbs[547, 0:300])
