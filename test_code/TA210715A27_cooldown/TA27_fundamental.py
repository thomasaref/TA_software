...
class TA27_Read(Read_HDF5):
    def _default_folder(self):
        return Folder(base_dir="/Users/thomasaref/Dropbox/Current stuff/Logbook/TA210715A27_cooldown280216", quality="", main_dir="Data_0228")

class TA27_Fund(Agent):
...
qdt=QDT(material='LiNbYZ',
        ft="single",
        Np=3,
        Rn=7950.0, #(5300.0+5400.0)/2.0,
        W=25.0e-6,
        eta=0.5,
        flux_factor=0.306, #0.2945,
        voltage=1.21,
        offset=-0.05)
