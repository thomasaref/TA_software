...
class GaAs_Read(Read_HDF5):
    def _default_folder(self):
        return Folder(base_dir="/Users/thomasaref/Dropbox/Current stuff/Logbook/GaAs_sample", quality="", main_dir="S11_close_flux")

class GaAs_Fund(Agent):
