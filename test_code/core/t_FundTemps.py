...
class test(Atom):
    desc_Int="Ints can have units, show_value, unit_factor and low/high limits"
    t_int=Int().tag(unit="um", show_value=True, unit_factor=20, low=0, high=5, desc=desc_Int)
