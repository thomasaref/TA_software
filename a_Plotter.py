...
from numpy import angle, absolute, dtype, log10, meshgrid, arange, linspace, sin, mean, amax, amin, reshape
...
#Magvec=Magvec[:,0,:, 9]+1j*Magvec[:,1,:, 9]
...
#    segs.append(list(zip(freq, Magvec[:, 143])))
    segs.append(list(zip(yoko, Magvec[923, :])))
    ...
    if __name__=="__main__":
        ...
        a.title="Reflection flux map, {0} dBm".format(pwr[powind]-87)
        a.xlabel="Flux Yoko (V)"
